...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/info/css/open-iconic-bootstrap.min.css">
    ...
    <link rel="stylesheet" href="/info/css/magnific-popup.css">

    <link rel="stylesheet" href="/info/css/aos.css">

    <link rel="stylesheet" href="/info/css/ionicons.min.css">

    <link rel="stylesheet" href="/info/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="/info/css/jquery.timepicker.css">

    
    <link rel="stylesheet" href="/info/css/flaticon.css">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              <h1 class="mb-3 mt-5 bread">Info Rumah sakit</h1>
            </div>
  ...
  <script src="/info/js/jquery-migrate-3.0.1.min.js"></script>
  ...
  <script src="/info/js/jquery.stellar.min.js"></script>
  <script src="/info/js/owl.carousel.min.js"></script>
  <script src="/info/js/jquery.magnific-popup.min.js"></script>
  <script src="/info/js/aos.js"></script>
  <script src="/info/js/jquery.animateNumber.min.js"></script>
  <script src="/info/js/bootstrap-datepicker.js"></script>
  <script src="/info/js/jquery.timepicker.min.js"></script>
  <script src="/info/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="/info/js/google-map.js"></script>
